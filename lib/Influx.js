    ...
    return new Influx.InfluxDB({
      ...
      schema: [
        ...
        },
        {
          ...
          tags: ['path', 'url', 'geohash', 'country', 'city'],
        },
      ],
    });
  },
        ...
        _.map(multiLogData, object => {
          return {
            tags: {
              path: object.path,
              url: object.url,
              geohash: object.location && object.location.geohash ? object.location.geohash : 'notFound',
              country: object.location && object.location.country ? object.location.country : 'notFound',
